...
// Asegúrate de que las rutas de importación de tus DTOs sean correctas.
import { CreateProvinceDto } from './create-province.dto'; // <<-- Ruta corregida
import { UpdateProvinceDto } from './update-province.dto'; // <<-- Ruta corregida
